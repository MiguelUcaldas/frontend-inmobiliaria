...
@Component({
  selector: 'app-ver-inmueble-venta',
  templateUrl: './ver-inmueble-venta.component.html',
  styleUrls: ['./ver-inmueble-venta.component.css']
})
export class VerInmuebleVentaComponent {
