...
@Component({
  selector: 'app-ver-inmueble-renta',
  templateUrl: './ver-inmueble-renta.component.html',
  styleUrls: ['./ver-inmueble-renta.component.css']
})
export class VerInmuebleRentaComponent {
